...
public class MerchantsInterfaces extends BaseController{
	 ...
	 * @throws Exception
	 */
	@RequestMapping(params = "getMerchantsStar", method = RequestMethod.POST)
	public void getMerchantsStar(MerchantsBean merchantsBean,HttpServletRequest request,
			HttpServletResponse response) throws Exception {	
		WriteObject(response, merchantsServiceI.getMerchantsStar(merchantsBean));
	}
