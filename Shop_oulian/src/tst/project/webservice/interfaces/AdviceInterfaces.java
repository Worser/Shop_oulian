...
public class AdviceInterfaces extends BaseController {
	 ...
	 * @throws Exception
	 */
	@RequestMapping(params = "insertMemberAdvice", method = RequestMethod.POST)
	public void insertMemberAdvice(HttpServletRequest request, HttpServletResponse response,
			AdviceBean adviceBean,MemberBean memberBean) {
		try {
			...
			int num = adviceService.insertMemberAdvice(adviceBean);
			if (num >= 0) {
