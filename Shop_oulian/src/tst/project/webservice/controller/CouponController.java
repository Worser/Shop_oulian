...
public class CouponController extends BaseController{
	...
	public void insertCoupon(MerchantsAccountBean merchantsAccountBean,
			CouponBean couponBean,HttpServletRequest request,
	...
	public void updateCoupon(MerchantsAccountBean merchantsAccountBean,
			CouponBean couponBean,HttpServletRequest request,
			HttpServletResponse response) throws Exception {
		if(!systemService.verToken(merchantsAccountBean)){
			WritePending(response, "token failed");
	...
	public void deleteCoupon(MerchantsAccountBean merchantsAccountBean,
			CouponBean couponBean,HttpServletRequest request,
			HttpServletResponse response) throws Exception {
		if(!systemService.verToken(merchantsAccountBean)){
			WritePending(response, "token failed");
	...
	public void getCoupons(MerchantsAccountBean merchantsAccountBean,
			CouponBean couponBean,PageBean pageBean,HttpServletRequest request,
			HttpServletResponse response) throws Exception {
		if(!systemService.verToken(merchantsAccountBean)){
			WritePending(response, "token failed");
			return;
