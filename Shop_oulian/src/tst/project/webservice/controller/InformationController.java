...
public class InformationController extends BaseController{
	...
	public void insertInformation(MerchantsAccountBean merchantsAccountBean,
		...
		if(num>0){
			WriteObject(response,informationBean);
		}else{
	...
	public void getInformations(MerchantsAccountBean merchantsAccountBean,
	...
	public void getInformationDetail(MerchantsAccountBean merchantsAccountBean,
			InformationBean informationBean,HttpServletRequest request,
			HttpServletResponse response) throws Exception {
		if(!systemService.verToken(merchantsAccountBean)){
			WritePending(response, "token failed");
		...
		WriteObject(response, informationServiceC.getInformationDetail(informationBean));
	 ...
	 * @throws Exception
	 */
	@RequestMapping(params = "getInformationsNoPage", method = RequestMethod.POST)
	public void getInformationsNoPage(MerchantsAccountBean merchantsAccountBean,
			InformationBean informationBean,PageBean pageBean,HttpServletRequest request,
			HttpServletResponse response) throws Exception {
		if(!systemService.verToken(merchantsAccountBean)){
			WritePending(response, "token failed");
		...
		WriteObject(response, informationServiceC.getInformationsNoPage(informationBean));
