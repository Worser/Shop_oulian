...
//		}
	 ...
	 * @throws Exception
	 */
	@RequestMapping(params = "getSystemDetailShowsRole", method = RequestMethod.POST)
	public void getSystemDetailShowsRole(MerchantsAccountBean merchantsAccountBean,DetailBean detailBean
			,PageBean pageBean,HttpServletRequest request,
			HttpServletResponse response) throws Exception {
		...
		WriteObject(response, systemService.getSystemDetailShowsRole(detailBean));
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping(params = "getAuthorityByRoleV2", method = RequestMethod.POST)
	public void getAuthorityByRoleV2(MerchantsAccountBean merchantsAccountBean,MoudleBean moudleBean,HttpServletRequest request,
			HttpServletResponse response) throws Exception {
		if(!systemService.verToken(merchantsAccountBean)){
			WritePending(response, "token failed");
			return;
		...
		WriteObject(response, systemService.getAuthorityByRoleV2(moudleBean));
	}
	/**
	 * 分配角色权限
	 * @param roleBean
