...
public class GoodsController extends BaseController{
	 ...
	 * @throws Exception
	 */
	@RequestMapping(params = "getGoodsManuals", method = RequestMethod.POST)
	public void getGoodsManuals(MerchantsAccountBean merchantsAccountBean,ManualBean manualBean,HttpServletRequest request,
		...
		WriteObject(response, goodsService.getGoodsManuals(manualBean));
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping(params = "insertGoodsManual", method = RequestMethod.POST)
	public void insertGoodsManual(MerchantsAccountBean merchantsAccountBean,ManualBean manualBean,HttpServletRequest request,
			HttpServletResponse response) throws Exception{
		if(!systemService.verToken(merchantsAccountBean)){
			WritePending(response, "token failed");
			return;
		...
		int num=goodsService.insertGoodsManual(manualBean);
		if(num>0){
	 ...
	 * @throws Exception
	 */
	@RequestMapping(params = "updateGoodsManual", method = RequestMethod.POST)
	public void updateGoodsManual(MerchantsAccountBean merchantsAccountBean,ManualBean manualBean,HttpServletRequest request,
			HttpServletResponse response) throws Exception{
		if(!systemService.verToken(merchantsAccountBean)){
			WritePending(response, "token failed");
			return;
		...
		int num=goodsService.updateGoodsManual(manualBean);
		if(num>0){
	 ...
	 * @throws Exception
	 */
	@RequestMapping(params = "deleteGoodsManual", method = RequestMethod.POST)
	public void deleteGoodsManual(MerchantsAccountBean merchantsAccountBean,ManualBean manualBean,HttpServletRequest request,
			HttpServletResponse response) throws Exception{
		if(!systemService.verToken(merchantsAccountBean)){
			WritePending(response, "token failed");
			return;
		...
		int num=goodsService.deleteGoodsManual(manualBean);
		if(num>0){
	 ...
	 * @throws Exception
	 */
	@RequestMapping(params = "getGoodsNews", method = RequestMethod.POST)
	public void getGoodsNews(MerchantsAccountBean merchantsAccountBean,GoodsNewBean goodsNewBean,HttpServletRequest request,
			HttpServletResponse response) throws Exception{
		if(!systemService.verToken(merchantsAccountBean)){
			WritePending(response, "token failed");
			return;
		...
		WriteObject(response, goodsService.getGoodsNews(goodsNewBean));
	}
	/**
	 * 添加新品商品
	 * @param request
	 ...
	 * @throws Exception
	 */
	@RequestMapping(params = "insertGoodsNew", method = RequestMethod.POST)
	public void insertGoodsNew(MerchantsAccountBean merchantsAccountBean,GoodsNewBean goodsNewBean,HttpServletRequest request,
			HttpServletResponse response) throws Exception{
		if(!systemService.verToken(merchantsAccountBean)){
			WritePending(response, "token failed");
			return;
		...
		int num=goodsService.insertGoodsNew(goodsNewBean);
		if(num>0){
			WriteMsg(response, "添加成功");
		}else{
			WriteError(response, "添加失败");
	 ...
	 * @throws Exception
	 */
	@RequestMapping(params = "updateGoodsNew", method = RequestMethod.POST)
	public void updateGoodsNew(MerchantsAccountBean merchantsAccountBean,GoodsNewBean goodsNewBean,HttpServletRequest request,
			HttpServletResponse response) throws Exception{
		if(!systemService.verToken(merchantsAccountBean)){
			WritePending(response, "token failed");
			return;
		...
		int num=goodsService.updateGoodsNew(goodsNewBean);
		if(num>0){
			WriteMsg(response, "修改成功");
		}else{
			WriteError(response, "修改失败");
	 ...
	 * @throws Exception
	 */
	@RequestMapping(params = "deleteGoodsNew", method = RequestMethod.POST)
	public void deleteGoodsNew(MerchantsAccountBean merchantsAccountBean,GoodsNewBean goodsNewBean,HttpServletRequest request,
			HttpServletResponse response) throws Exception{
		if(!systemService.verToken(merchantsAccountBean)){
			WritePending(response, "token failed");
			return;
		...
		int num=goodsService.deleteGoodsNew(goodsNewBean);
		if(num>0){
			WriteMsg(response, "删除成功");
		}else{
			WriteError(response, "删除失败");
	 ...
	 * @throws Exception
	 */
	@RequestMapping(params = "getGoodsClassByParentIdPage", method = RequestMethod.POST)
	public void getGoodsClassByParentIdPage(MerchantsAccountBean merchantsAccountBean,GoodsBean goodsBean,HttpServletRequest request,
		...
		WriteObject(response, goodsService.getGoodsClassByParentIdPage(goodsBean,pageBean),pageBean.getTotal());
	}
	/**
	 * 获得所有分类数据
	 * @param request
	...
	public void getAllGoodsClassNoPage(MerchantsAccountBean merchantsAccountBean,GoodsBean goodsBean,HttpServletRequest request,
		...
		List<GoodsBean> goodsBeans = goodsService.getAllGoodsClassNoPage(goodsBean);
		
		if(all!=null && !all.equals("") && all.equals("1"))
		{
			goodsBeans.add(0, new GoodsBean().setGoods_name("全部"));
		}
	...
	public void insertGoodsClass(MerchantsAccountBean merchantsAccountBean,GoodsBean goodsBean,HttpServletRequest request,
		...
		if(num>0){
			...
			WriteMsg(response, goodsBean.getGoods_id()+"");
		}else{
			WriteError(response, "添加失败");
		}
	}
	...
	public void loadGoodsClassExcel(MerchantsAccountBean merchantsAccountBean,HttpServletRequest request,
		...
		System.out.println(new Gson().toJson(goodsBeans)+"--============================");
...
//		}
	...
	public void insertGoodsDetailAll(MerchantsAccountBean merchantsAccountBean,GoodsBean goodsBean,HttpServletRequest request,
		...
		int num=goodsService.insertGoodsDetailAll(request,goodsBean.setGoods_uuid(uuid).setGoods_url( path+"/"+fileName)
...
//		String result=ExcelUtils.readExcel("C:\\Users\\JOSY.Lenovo-PC\\Desktop\\111.xls");
	 ...
	 * @throws Exception
	 */
	@RequestMapping(params = "loadGoodsDetailExcelOulian", method = RequestMethod.POST)
	public void loadGoodsDetailExcelOulian(MerchantsAccountBean merchantsAccountBean,HttpServletRequest request,
			HttpServletResponse response) throws Exception {
		String json=uploadFile(request, "/excel/");		
		if(json.equals("-1")){
			WriteError(response, "文件不可为空");
		...
		//String result=ExcelUtils.readExcel(request.getSession().getServletContext().getRealPath("/")+"/excel/123.xlsx");

		List<GoodsBean> goodsBeans=new Gson().fromJson(result, new TypeToken<List<GoodsBean>>() {}.getType());
	
		int num=goodsService.insertGoodsDetails(goodsBeans);
	...
	public void updateGoodsDetailAll(MerchantsAccountBean merchantsAccountBean,GoodsBean goodsBean,HttpServletRequest request,
		...
		List<GoodsParameterBean> goodsParameterBeans=new Gson().fromJson(request.getParameter("parameters"), new TypeToken<List<GoodsParameterBean>>(){}.getType());
		List<StandardBean> standardBeans=new Gson().fromJson(request.getParameter("standards"), new TypeToken<List<StandardBean>>(){}.getType());
		int num=goodsService.updateGoodsDetailAll(request,goodsBean,goodsLabelBeans,goodsImgBeans,goodsParameterBeans,standardBeans);
		if(num>0){
			ClassMoudle.getInstance().setGoods1Beans(null);
			ClassMoudle.getInstance().setGoods2Beans(null);
			ClassMoudle.getInstance().setGoods3Beans(null);
...
//		}
	 ...
	 * 查询会员所传型号
	 */
	@RequestMapping(params = "getVipGoodsNameList")
	public void getVipGoodsNameList(MerchantsAccountBean merchantsAccountBean,
			GoodsBean goodsBean,PageBean pageBean,
			HttpServletRequest request,
			HttpServletResponse response) throws Exception{	
		if(!systemService.verToken(merchantsAccountBean)){
			WritePending(response, "token failed");
		...
		WriteObject(response, goodsService.getVipGoodsNameList(goodsBean, pageBean),pageBean.getTotal());
	}	
	
	/**
	 * 导出会员所传型号
	 */
	@RequestMapping(params = "exportVipGoodsNameList")
	public void exportVipGoodsNameList(MerchantsAccountBean merchantsAccountBean,
			GoodsBean goodsBean,
			HttpServletRequest request,
			HttpServletResponse response) throws Exception{	
		if(!systemService.verToken(merchantsAccountBean)){
		...
		List<ExcelBean> excelBeans=new ArrayList<ExcelBean>();
		excelBeans.add(new ExcelBean().setName("ID").setType("goods_id"));
		excelBeans.add(new ExcelBean().setName("型号名称").setType("goods_name"));
		excelBeans.add(new ExcelBean().setName("供应商名称").setType("merchants_name"));
		excelBeans.add(new ExcelBean().setName("库存").setType("goods_stock"));
		...
		excelBeans.add(new ExcelBean().setName("日期").setType("create_time"));
		
		List<Object> memberEntrustBeans = goodsService.exportVipGoodsNameList(goodsBean);
	 ...
	 * 导出商品信息（欧联）
	 */
	@RequestMapping(params = "exportGoodsExcelOulian")
	public void exportGoodsExcelOulian(MerchantsAccountBean merchantsAccountBean,
			GoodsBean goodsBean,
			HttpServletRequest request,
			HttpServletResponse response) throws Exception{	
		if(!systemService.verToken(merchantsAccountBean)){
		...
		excelBeans.add(new ExcelBean().setName("最小起订量").setType("min_buy_num"));
		excelBeans.add(new ExcelBean().setName("可替换型号").setType("replace_name"));
		excelBeans.add(new ExcelBean().setName("型号别名").setType("goods_alias"));
		excelBeans.add(new ExcelBean().setName("交期").setType("give_time"));
		excelBeans.add(new ExcelBean().setName("商品描述").setType("goods_desc"));
		excelBeans.add(new ExcelBean().setName("是否维护图片").setType("is_goods_img"));
		excelBeans.add(new ExcelBean().setName("创建时间").setType("create_time"));
		
		List<Object> goodsBeans = goodsService.exportGoodsExcelOulian(goodsBean);
	...
	public void batchDelete(MerchantsAccountBean merchantsAccountBean,
		...
		int num = goodsService.batchDelete(goodsBean);
		if(num > 0)
		{
	 ...
	 * 全部删除
	 */
	@RequestMapping(params = "allDelete")
	public void allDelete(MerchantsAccountBean merchantsAccountBean,
		...
		int num = goodsService.allDelete(goodsBean);
		if(num > 0)
		{
			WriteObject(response, "操作成功");
		}else
