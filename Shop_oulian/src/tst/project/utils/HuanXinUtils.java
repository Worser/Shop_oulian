...
public class HuanXinUtils {
	 ...
	 * 注册一个用户
	 */
	public static boolean registerOneUser(String username,String password,String nickname){
		Client client = ClientBuilder.newClient();
		WebTarget target = client.target(url+id+"/"+name+"/users");
	 ...
	 * @return
	 */
	public static String getChatRecord(String time){
		Client client = ClientBuilder.newClient();
