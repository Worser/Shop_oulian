...
public class SendOrderForMember extends Thread
{
  private MemberBean memberBean2 = null;
  private List<OrderGoodsBean> orderGoodsBean1 = null;

  public SendOrderForMember(MemberBean memberBean2, List<OrderGoodsBean> orderGoodsBean1)
  {
  ...
  public void run()
  {
    ...
    try
    {
      ...
      sbd.append("卖家已经发货，预计在N天到达您指定的地点，请您耐心等待！<br/><br/><br/>");
      sbd.append("------------------------------------------------<br/>");
