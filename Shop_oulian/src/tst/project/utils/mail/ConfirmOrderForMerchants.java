...
public class ConfirmOrderForMerchants extends Thread
{
  private MemberBean memberBean2 = null;
  private List<OrderGoodsBean> orderGoodsBean1 = null;

  public ConfirmOrderForMerchants(MemberBean memberBean2, List<OrderGoodsBean> orderGoodsBean1)
  {
  ...
  public void run()
  {
    ...
    try
    {
      ...
      msg.setSubject(this.memberBean2.getCompany_name() + ",订单发货提醒！！");
      ...
      sbd.append("买家已经确认收到货啦！！平台将会在48小时内给您进行打款，请您耐心等待！！<br/><br/><br/>");
      sbd.append("------------------------------------------------<br/>");
