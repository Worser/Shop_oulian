...
public class acceptOrderForMember extends Thread
{
  private MemberBean memberBean2 = null;
  private List<OrderGoodsBean> orderGoodsBean1 = null;

  public acceptOrderForMember(MemberBean memberBean2, List<OrderGoodsBean> orderGoodsBean1)
  {
  ...
  public void run()
  {
    ...
    try
    {
      ...
      sbd.append("卖家已通过审核，请您在30分钟内登陆平台进行支付，否则订单将会被自动取消。<br/><br/><br/>");
      sbd.append("------------------------------------------------<br/>");
