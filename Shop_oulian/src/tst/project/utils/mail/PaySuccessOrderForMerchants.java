...
public class PaySuccessOrderForMerchants extends Thread
{
  private MemberBean memberBean2 = null;
  private OrderGoodsBean orderGoodsBean1 = null;

  public PaySuccessOrderForMerchants(MemberBean memberBean2, OrderGoodsBean orderGoodsBean1)
  {
  ...
  public void run()
  {
    ...
    try
    {
      ...
      sbd.append("&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;您的商品【" + 
        this.orderGoodsBean1.getGoods_name() + 
        "】，买家已经付款，平台已经确认收到货款，请您尽快协调发货。<br/><br/><br/>");
      sbd.append("------------------------------------------------<br/>");
