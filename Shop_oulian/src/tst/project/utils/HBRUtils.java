...
public class HBRUtils {
	public static String url="http://121.43.228.194:8079/axis2/services/WebServices?wsdl";
	 ...
	 * @throws Exception 
	 */
	public static void modifyIntegral() throws Exception{
		// 使用RPC方式调用WebService
				RPCServiceClient serviceClient = new RPCServiceClient();
				Options options = serviceClient.getOptions();
				// 指定调用WebService的URL
				EndpointReference targetEPR = new EndpointReference("http://121.43.228.194:8079/axis2/services/WebServices");
				...
				String xml = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>"
								+ "<root>"
									...
									+ "<CREDATE>2017-01-02</CREDATE>"
									+ "<COMEFROM>17</COMEFROM>"
									+ "<SOURCEID>bbbbb</SOURCEID>"
									+ "<INTEGRAL>-200</INTEGRAL>"
									+ "<IDTYPE>1</IDTYPE>"
									+ "</info>"
								+ "</root>";
	 ...
	 * @throws Exception 
	 */
	public static void SvcardBalance() throws Exception{
		// 使用RPC方式调用WebService
				RPCServiceClient serviceClient = new RPCServiceClient();
				Options options = serviceClient.getOptions();
				// 指定调用WebService的URL
	 ...
	 * @throws Exception 
	 */
	public static void svcardPrepay() throws Exception{
		// 使用RPC方式调用WebService
				RPCServiceClient serviceClient = new RPCServiceClient();
				Options options = serviceClient.getOptions();
				// 指定调用WebService的URL
	 ...
	 * @throws Exception 
	 */
	public static void svcardDeal() throws Exception{
		// 使用RPC方式调用WebService
				RPCServiceClient serviceClient = new RPCServiceClient();
				Options options = serviceClient.getOptions();
				// 指定调用WebService的URL
		...
		// 使用RPC方式调用WebService
				...
				String xml = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>"
							+ "<root>"
								+ "<info>"
								+ "<INSIDERCARDNO>15026592830</INSIDERCARDNO>"
								+ "<CREDATE>2017-01-03</CREDATE>"
								+ "<COMEFROM>23</COMEFROM>"
								+ "<IDTYPE>2</IDTYPE>"
								+ "<SOURCEID>bbbbb</SOURCEID>"
	 ...
	 * @throws Exception 
	 */
	public static void refundOrder(String stored_code,String psw,String order_id,String money) throws Exception{
		// 使用RPC方式调用WebService
				RPCServiceClient serviceClient = new RPCServiceClient();
				Options options = serviceClient.getOptions();
				// 指定调用WebService的URL
