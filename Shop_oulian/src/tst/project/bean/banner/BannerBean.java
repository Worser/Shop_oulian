...
public class BannerBean {
	...
	private List<BannerButtonBean> bannerButtonBeans;
	
	public List<BannerButtonBean> getBannerButtonBeans() {
		return bannerButtonBeans;
	}
	public BannerBean setBannerButtonBeans(List<BannerButtonBean> bannerButtonBeans) {
		this.bannerButtonBeans = bannerButtonBeans;
		return this;
	}
	...
	public BannerBean setGoods_uuid(String goods_uuid) {
	...
	public BannerBean setGoods_class_name(String goods_class_name) {
	...
	public BannerBean setGoods_name(String goods_name) {
