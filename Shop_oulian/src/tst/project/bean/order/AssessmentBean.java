...
public class AssessmentBean {
	...
	private String merchants_remark;
	...
	public String getMerchants_remark() {
		return merchants_remark;
	}
	public AssessmentBean setMerchants_remark(String merchants_remark) {
		this.merchants_remark = merchants_remark;
		return this;
	}
	public OrderBean getOrderBean() {
		return orderBean;
	}
	public AssessmentBean setOrderBean(OrderBean orderBean) {
