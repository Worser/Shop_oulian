...
public interface GoodsDao {
	 ...
	 * @return
	 */
	public GoodsBean getOneGoodsClassByParentId(GoodsBean goodsBean);
	 ...
	 * 批量导入型号（欧联）
	 */
	public int updateGoodsDetails(GoodsBean goodsBean);
	
	/**
	 * 批量导入型号（欧联）
	 */
	public int deleteGoodsDetails(GoodsBean goodsBean);
