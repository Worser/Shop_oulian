...
public class SystemService {
	 ...
	 * @return
	 */
	public List<DetailBean> getSystemDetailShowsRole(DetailBean detailBean){
		return systemDao.getSystemDetailShowsRole(detailBean);
	}
	 ...
	 * @return
	 */
	public int insertSystemDetailRole(DetailBean detailBean){
		return systemDao.insertSystemDetailRole(detailBean);
	}
	 ...
	 * @return
	 */
	public int updateSystemDetailRole(DetailBean detailBean){
		return systemDao.updateSystemDetailRole(detailBean);
	}
	 ...
	 * @return
	 */
	public List<MoudleBean> getAuthorityByRoleV2(MoudleBean moudleBean) {
		List<MoudleBean> moudleBeans = systemDao.getAuthorityByRole(moudleBean);
		return moudleBeans;
	}
	 ...
	 * @throws Exception 
	 */
	public int insertMerchantsAccount(MerchantsAccountBean merchantsAccountBean) throws Exception {
		int num = systemDao.insertMerchantsAccount(merchantsAccountBean);
		if(num > 0)
		{
			int k = insertMerchantsRelationAccount(merchantsAccountBean.setIs_default("1"));
			if (k <= 0) {
	...
	public int insertMerchantsRelationAccount(MerchantsAccountBean merchantsAccountBean) {
		return systemDao.insertMerchantsRelationAccount(merchantsAccountBean);
	}
