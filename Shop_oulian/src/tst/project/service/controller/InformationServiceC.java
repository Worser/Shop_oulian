...
public class InformationServiceC {	
	 ...
	 * @return
	 */
	public List<InformationBean> getInformationsNoPage(InformationBean informationBean){
		List<InformationBean> informationBeans=informationDaoC.getInformationsNoPage(informationBean);
		return informationBeans;
	}
}
