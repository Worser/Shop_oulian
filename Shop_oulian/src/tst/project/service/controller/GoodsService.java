...
public class GoodsService {
	 ...
	 * @return
	 */
	public List<ManualBean> getGoodsManuals(ManualBean manualBean){
		return goodsDao.getGoodsManuals(manualBean);
	}
	 ...
	 * @return
	 */
	public int insertGoodsManual(ManualBean manualBean){
		return goodsDao.insertGoodsManual(manualBean);
	}
	 ...
	 * @return
	 */
	public int updateGoodsManual(ManualBean manualBean){
		return goodsDao.updateGoodsManual(manualBean);
	}
	 ...
	 * @return
	 */
	public int deleteGoodsManual(ManualBean manualBean){
		return goodsDao.deleteGoodsManual(manualBean);
	}
	/**
	 * 获得新品商品
	 * @return
	...
	public List<GoodsNewBean> getGoodsNews(GoodsNewBean goodsNewBean){
		return goodsDao.getGoodsNews(goodsNewBean);
	}
	 ...
	 * @return
	 */
	public int insertGoodsNew(GoodsNewBean goodsNewBean){
		return goodsDao.insertGoodsNew(goodsNewBean);
	}
	 ...
	 * @return
	 */
	public int updateGoodsNew(GoodsNewBean goodsNewBean){
		return goodsDao.updateGoodsNew(goodsNewBean);
	}
	 ...
	 * @return
	 */
	public int deleteGoodsNew(GoodsNewBean goodsNewBean){
		return goodsDao.deleteGoodsNew(goodsNewBean);
	}
...
//	
	 ...
	 * @return
	 */
	public List<GoodsBean> getGoodsClassByParentIdPage(GoodsBean goodsBean,PageBean pageBean)
	{
		return goodsDao.getGoodsClassByParentIdPage(goodsBean, pageBean);
	}
...
//		}
	...
	public int loadGoodsDetailExcel(List<GoodsBean> goodsBeans, HttpServletRequest request) throws Exception {
		...
		if (goodsBeans != null) {
			for (int i = 0; i < goodsBeans.size(); i++) {
				...
				String parent_id=goodsBeans2.get(i/10).getGoods_id()+"";
				String brand_id=(i/167)+"";
	...
	public int loadGoodsDetailExcel(List<GoodsBean> goodsBeans, HttpServletRequest request) throws Exception {
		...
		if (goodsBeans != null) {
			for (int i = 0; i < goodsBeans.size(); i++) {
				GoodsBean goodsBean = goodsBeans.get(i);
				List<GoodsBean> goodsBean1 = goodsDao.getGoodsClassByParentId(new GoodsBean().setGoods_type("1")
						   .setParent_id("-1").setGoods_name(goodsBean.getBrand_name()));
				
				if(goodsBean1.size()==0)
				{
					goodsBean1 = goodsDao.getGoodsClassByParentId(new GoodsBean().setGoods_type("1")
							   .setParent_id("-1").setGoods_name("其他"));
				}
				
				num = insertGoodsDetail(goodsBean
						.setParent_id(goodsBean1.get(0).getGoods_id()+"")
						.setMerchants_id("1")
						.setGoods_state("1")
						.setGoods_uuid(UUID.randomUUID().toString())
						.setGoods_img("/images/goods/"+goodsBean.getGoods_name()+".jpg")
						.setGoods_imgs("/images/goods/1483448955139.png,/images/goods/1476858195751.png")
						.setGoods_type("2")
						.setGoods_now_price(CreateRandom.createRandom(true, 4)), null, request);		
			}
	...
	public int insertGoodsDetail(GoodsBean goodsBean, List<GoodsLabelBean> labelBeans,HttpServletRequest request) throws Exception {
		...
		int num = 0;
		GoodsBean goodsBean1 = goodsDao.getGoodsInfo(goodsBean);
		if(goodsBean1==null)
		{
			num = goodsDao.insertGoodsDetail(goodsBean);
			if (num > 0) {
		...
		{
			num = goodsDao.updateGoodsDetail(goodsBean.setGoods_id(goodsBean1.getGoods_id()));
			if(num<0)
			{
	 ...
	 * @throws Exception
	 */
	public int insertGoodsDetailAll(HttpServletRequest request,GoodsBean goodsBean, List<GoodsLabelBean> labelBeans,
		...
		if(FileUtils.isFileExists(request.getSession().getServletContext().getRealPath("/")+goodsBean.getGoods_img())){
			goodsBean.setIs_goods_img("1");
		}else{
			goodsBean.setIs_goods_img("0");
		}
...
//			}
	 ...
	 * @throws Exception
	 */
	public int updateGoodsDetailAll(HttpServletRequest request,GoodsBean goodsBean, List<GoodsLabelBean> labelBeans,
			List<GoodsImgBean> goodsImgBeans, List<GoodsParameterBean> goodsParameterBeans,
			List<StandardBean> standardBeans) throws Exception {
...
//			}
	 ...
	 * 查询会员所传型号
	 */
	public List<GoodsBean> getVipGoodsNameList(GoodsBean goodsBean,PageBean pageBean)
	{
		return goodsDao.getVipGoodsNameList(goodsBean, pageBean);
	}

	/**
	 * 导出会员所传型号
	 */
	public List<Object> exportVipGoodsNameList(GoodsBean goodsBean)
	{
		return goodsDao.exportVipGoodsNameList(goodsBean);
	}
	
	/**
	 * 导出商品信息（欧联）
	 */
	public List<Object> exportGoodsExcelOulian(GoodsBean goodsBean)
	{
		return goodsDao.exportGoodsExcelOulian(goodsBean);
	}
	
	/**
	 * 批量导入型号（欧联）
	 */
	public int insertGoodsDetails(List<GoodsBean> goodsBeans)
	{
		HashSet h = new HashSet(goodsBeans);      
		goodsBeans.clear();      
		goodsBeans.addAll(h);     
		...
		for (int i = 0; i < goodsBeans.size(); i++) {
			...
			goodsBeans.get(i).setGoods_uuid(UUID.randomUUID().toString());
			goodsBeans.get(i).setGoods_img("/images/goods/"+goodsBeans.get(i).getGoods_name()+".jpg");
			goodsBeans.get(i).setGoods_now_price(CreateRandom.createRandom(true, 4));
		}
		int num=goodsDao.insertGoodsDetails(goodsBeans);
		goodsDao.updateGoodsDetails(new GoodsBean().setGoods_no(record_no));
		goodsDao.deleteGoodsDetails(new GoodsBean().setGoods_no(record_no));
		return 1;
	}
	 ...
	 * 批量删除
	 */
	public int batchDelete(GoodsBean goodsBean)
	{
		return goodsDao.batchDelete(goodsBean);
	}
	
	/**
	 * 全部删除
	 */
	public int allDelete(GoodsBean goodsBean)
	{
		return goodsDao.allDelete(goodsBean);
	}
}
