...
public class MerchantsServiceI {
	...
	public Map getMerchantsStar(MerchantsBean merchantsBean){
		return merchantsDaoI.getMerchantsStar(merchantsBean);
	}
	/**
	 * 店铺的分类列表
	 * @return
	...
	public List<MerchantsBean> searchMerchants(MerchantsBean merchantsBean,PageBean pageBean){
		return merchantsDaoI.searchMerchants(merchantsBean, pageBean);
	}
